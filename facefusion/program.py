...
def create_source_paths_program() -> ArgumentParser:
	...
	group_paths.add_argument('--source', help = 'Comma-separated source image paths', type=str, default=None)
	job_store.register_step_keys([ 'source_paths', 'source' ])
	return program
...
def create_face_selector_program() -> ArgumentParser:
	...
	group_face_selector.add_argument('--reference-face-path', help='Path to a custom reference face image (comma-separated for multiple)', type=str, default=None)
